...
class Particle:
    ...
    def update_velocity(self, global_best_position: List[float], c1: float = 2.0, c2: float = 2.0) -> None:
        '''
        Обновляет скорость частицы на основе её лучшей позиции и глобальной лучшей позиции роя.
        Параметры:
